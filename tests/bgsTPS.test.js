...
describe(`Test BGS Coordinates with TPS transformation dS = ${DELTA_BGS}m`, () => {
  it('BGS 1930 24 degrees', () => {
    ...
    let result = tr.transform(input, projections.BGS_1930_24, projections.BGS_2005_KK, true);
    checkResult(expected, result, DELTA_BGS);

    input = [4728401.432, 483893.508];
    expected = [4728966.163, 8607005.227];
    result = tr.transform(input, projections.BGS_2005_KK, projections.BGS_1930_24, true);
    checkResult(expected, result, DELTA_BGS);
  });
  ...
  it('BGS 1930 27 degrees', () => {
    ...
    let expected = [4728401.432, 483893.508];
    let result = tr.transform(input, projections.BGS_1930_27, projections.BGS_2005_KK, true);
    checkResult(expected, result, DELTA_BGS);

    input = [4728401.432, 483893.508];
    expected = [4729531.133, 9361175.733];
    result = tr.transform(input, projections.BGS_2005_KK, projections.BGS_1930_27, true);
    checkResult(expected, result, DELTA_BGS);
  });
  ...
  it('BGS 1950 3 24 degrees', () => {
    ...
    let expected = [4728401.432, 483893.508];
    let result = tr.transform(input, projections.BGS_1950_3_24, projections.BGS_2005_KK, true);
    checkResult(expected, result, DELTA_BGS);
    tr.tra;
    input = [4728401.432, 483893.508];
    expected = [4729331.175, 8606933.614];
    result = tr.transform(input, projections.BGS_2005_KK, projections.BGS_1950_3_24, true);
    checkResult(expected, result, DELTA_BGS);
  });
  ...
  it('BGS 1950 3 27 degrees', () => {
    ...
    let expected = [4728401.432, 483893.508];
    let result = tr.transform(input, projections.BGS_1950_3_27, projections.BGS_2005_KK, true);
    checkResult(expected, result, DELTA_BGS);

    input = [4728401.432, 483893.508];
    expected = [4729899.053, 9361082.96];
    result = tr.transform(input, projections.BGS_2005_KK, projections.BGS_1950_3_27, true);
    checkResult(expected, result, DELTA_BGS);
  });
  ...
  it('BGS 1950 6 21 degrees', () => {
    ...
    let expected = [4728401.432, 483893.508];
    let result = tr.transform(input, projections.BGS_1950_6_21, projections.BGS_2005_KK, true);
    checkResult(expected, result, DELTA_BGS);

    input = [4728401.432, 483893.508];
    expected = [4737501.141, 4852808.182];
    result = tr.transform(input, projections.BGS_2005_KK, projections.BGS_1950_6_21, true);
    checkResult(expected, result, DELTA_BGS);
  });
  ...
  it('BGS 1950 6 27 degrees', () => {
    ...
    let expected = [4728401.432, 483893.508];
    let result = tr.transform(input, projections.BGS_1950_6_27, projections.BGS_2005_KK, true);
    checkResult(expected, result, DELTA_BGS);

    input = [4728401.432, 483893.508];
    expected = [4729899.053, 5361082.96];
    result = tr.transform(input, projections.BGS_2005_KK, projections.BGS_1950_6_27, true);
    checkResult(expected, result, DELTA_BGS);
  });
  ...
  it('BGS Sofia', () => {
    ...
    let result = tr.transform(input, projections.BGS_SOFIA, projections.BGS_2005_KK, true);
    checkResult(expected, result, DELTA_BGS);

    input = [4730215.229, 322402.935];
    expected = [48276.705, 45420.988];
    result = tr.transform(input, projections.BGS_2005_KK, projections.BGS_SOFIA, true);
    checkResult(expected, result, DELTA_BGS);
  });
